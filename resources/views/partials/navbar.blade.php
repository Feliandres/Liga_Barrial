...
<!-- Navbar start -->
<nav id="navbar" class="fixed top-0 z-40 flex w-full flex-row justify-end bg-cyan-600 px-4 sm:justify-between">
    ...
    <img src="{{ asset('/storage/logo.png') }}" class="w-64 h-24 m-2"/>
    <div class="flex mt-8">
        <a href="#" class="btn bg-teal-500 border-none hover:bg-teal-400 text-white mx-1">Iniciar Sesión</a>
        <a href="{{route('register')}}" class="btn bg-blue-500 border-none hover:bg-blue-400 text-white">Registrate</a>
    </div>
